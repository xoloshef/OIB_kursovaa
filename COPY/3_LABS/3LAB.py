...
if text == ("При построении системы безопасности применяются политики защиты основанные на требованиях определяемых направлениями деятельности компании"):
    print("Зашифрованное сообщение:")
    print(" ЯЕЕМДК, ЖМюьЙш Ь,  Н.ьИЗФ фяКячНэГН. ЬяЕЕььЙЛТО, УЬяГЗшЖЕъ ЬччХшЖЧМГНэГ, пВЙЗьЬэчЬ.ЕБрГ, пВЕЛЙЬюДМфыБыУБьПСМВяяЕясАБэ Ыь ЬуьЫ.ьЗИВК, ЖЕМ.КьДяэ Е")
    print("Расшифрованное сообщение:")
    print(" При построении системы безопасности применяются политики защиты основанные на требованиях определяемых направлениями деятельности компании")
else:
